...
GO
Create proc Artikal_Pregled_Slika
as
Select distinct a.artikal_id, a.ime,a.cena,a.opis,a.link,s.is_vidljivo,k.kategorija_ime from Artikal as a
inner join StatusArtikla as s
on
a.statusArtikla_id=s.statusArtikla_id
...
exec Korisnik_Insert 'Ognjen','Bozic','12345','ognjen.bozic@prvabeogim.edu.rs','Srbija','Beograd','Stari grad', 11000,'Bul desp Stef',1,'Musko'
exec Korisnik_Insert 'Dunja','Bozinovic','12345','dunja.bozinovic@prvabeogim.edu.rs','Srbija','Beograd','Stari grad', 11000,'Bul desp Stef',1,'Zensko'
exec Korisnik_Insert 'Ilija','Popovic','12345','ilija.popovic@prvabeogim.edu.rs','Srbija','Beograd','Stari grad', 11000,'Bul desp Stef',1,'Musko'
exec Korisnici_Svi

exec Artikal_Insert 'Air Max',15,1,1,'Nike Patike',10,'airmax'
exec Artikal_Insert 'Puma',15,1,1,'Patike',30,'puma'
Select * from Artikal
